              ...
              <div className="p-6 border-b border-slate-100 space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    ...
                    {(user.role === 'Finance Team' || (user.role === 'Master' && activeTab === 'finance')) && (
                      <>
                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-slate-50">
                      ...
                      <th className="p-4 border-b border-slate-100 text-[10px] font-black text-slate-500 uppercase tracking-widest">IFSC</th>
                    ...
                    {filteredOrders.length === 0 ? (
                      ...
                      filteredOrders.map((o) => (
                        <tr key={o.id} className={`transition-colors group ${o.processed_by_finance ? "bg-emerald-100/60" : o.approved_by_unit ? "bg-emerald-50/60" : "hover:bg-slate-50"}`}>
                          ...
                          <td className="p-4 border-b border-slate-50 text-xs font-black text-slate-900">{o.unit}</td>
                          ...
                          <td className="p-4 border-b border-slate-50 text-xs font-bold text-slate-400 uppercase">{o.ifsc_code}</td>
                          <td className="p-4 border-b border-slate-50 text-xs font-black text-[#673ab7]">₹{o.amount.toLocaleString()}</td>
                          <td className="p-4 border-b border-slate-50">
                            <span className={`text-[8px] font-black px-2 py-1 rounded uppercase tracking-widest ${
                              o.processed_by_finance ? "bg-emerald-100 text-emerald-700" :
